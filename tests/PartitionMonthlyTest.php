...
class PartitionDailyTest extends AbstractPartitionTest
{
    ...
    public function setUp()
    {
        ...
        $this->partition = new PartitionRotator(self::$pdo, $GLOBALS["DB_NAME"] , "test_rotate_monthly",
            new DateTime("2020-09-01"), new DateTime("2021-01-01"), new RotateModeMonthly() );
...
(PARTITION `start` VALUES LESS THAN (0) ENGINE = MyISAM,
 PARTITION from202009 VALUES LESS THAN (738033) ENGINE = MyISAM,
 PARTITION from202010 VALUES LESS THAN (738063) ENGINE = MyISAM,
 PARTITION from202011 VALUES LESS THAN (738094) ENGINE = MyISAM,
 PARTITION from202012 VALUES LESS THAN (738124) ENGINE = MyISAM,
 PARTITION future VALUES LESS THAN MAXVALUE ENGINE = MyISAM) 
    ...
    public function testGetPartitions()
    {
        ...
        $this->assertEquals("2020-08-31",$partitions[0]->getDate()->format("Y-m-d"));


        $this->assertEquals("from202012",$partitions[count($partitions)-1]->getName());
        $this->assertEquals("2020-11-30",$partitions[count($partitions)-1]->getDate()->format("Y-m-d"));
    }
